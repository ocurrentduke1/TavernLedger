...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <main className="min-h-screen bg-canvas flex items-center justify-center px-8 py-8">
        <div className="w-full max-w-[420px] bg-surface/60 border border-gold/20 px-12 py-12 text-center">
          <div className="font-cinzel-dec text-[2rem] text-gold mb-4">✦</div>
          <h2 className="font-cinzel-dec text-[1.3rem] text-gold mb-4">
    ...
    <main className="min-h-screen bg-canvas flex items-center justify-center px-8 py-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] bg-surface/60 border border-gold/20 px-12 py-12 relative z-10">
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="font-cinzel text-[0.65rem] tracking-[0.2em] uppercase text-prose-muted">o regístrate con</span>
          <div className="flex-1 h-px" style={{ background: "linear-gradient(to right, transparent, rgba(201,168,76,0.2), transparent)" }} />
        </div>
